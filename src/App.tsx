...
const DefaultLayout = ({ children }: { children: React.ReactNode }) => (
  <div className="min-h-screen bg-luxury-black">
    ...
    <a
      href="https://wa.me/15617774360?text=Hi%2C%20I'm%20interested%20in%20a%20rental%20from%20AuraPex"
      target="_blank"
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 bg-white text-gray-800 text-sm font-medium px-3 py-1.5 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
        Chat with us
      </span>
    </a>
  </div>
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/jet-skis" element={<DefaultLayout><JetSkisPage /></DefaultLayout>} />
